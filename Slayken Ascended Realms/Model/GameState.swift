...
final class GameState: ObservableObject {
    ...
    var battlePlayer: CharacterStats {
        CharacterStats(
            ...
            materialColor: player.materialColor,
            emissionColor: player.emissionColor,
            emissionIntensity: player.emissionIntensity,
            roughness: player.roughness,
            metalness: player.metalness,
            auraColor: player.auraColor,
            auraIntensity: player.auraIntensity,
            auraRadius: player.auraRadius,
            particleEffect: player.particleEffect,
            shadowColor: player.shadowColor,
            shadowOpacity: player.shadowOpacity,
